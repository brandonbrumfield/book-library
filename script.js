...
function addBookToLibrary(title, author, pages, read) {
    ...
    myLibrary.push(book); 
    displayBooks(book.title, book.author, book.pages, book.read, book.id);


}


function displayBooks(title,author,pages,read,id) {
...
addBookToLibrary('The Road', 'Cormac McCarthy', 287, "Read");
addBookToLibrary('Dracula', 'Bram Stoker', 560, "Read");
